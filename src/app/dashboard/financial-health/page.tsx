...
export default function FinancialHealthPage() {
  ...
  const load = useCallback(async () => {
    // Prevent concurrent duplicate fetches (e.g., React StrictMode double-invoke)
    ...
    <div className="space-y-8 animate-fade-in-up pb-10 max-w-7xl mx-auto">
      <div>
        ...
        <p className="text-gray-400">
          Seu score de saúde financeira atualizado diariamente.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          <div
            className={`${styles.glassCard} p-8 flex flex-col items-center justify-center relative overflow-hidden min-h-[400px]`}
          >
            <ScoreGauge score={data.score} level={data.level} />
          </div>

          {/* Emergency Fund Widget (New) */}
          {fundData && <EmergencyFundWidget fund={fundData} onUpdate={load} />}
